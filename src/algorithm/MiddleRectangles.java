...
public class MiddleRectangles {
    ...
    public MiddleRectangles(BigDecimal a, BigDecimal b, BigDecimal accuracy, int functionNumber){
        this.a = a;
        this.b = b;
    ...
    public ArrayList<ArrayList<BigDecimal>> solve(){
        ...
        while ((module.compareTo(accuracy) > 0) || (iterationCount < 3)){
            ...
            for (int i = 1; i <= n; i++){
                BigDecimal temp = a.add(h.multiply(new BigDecimal(i))).add(h.multiply(new BigDecimal(-0.5)));
